...
var e = {
    ...
    getNextSiblings: function(el, selector, filter) {
        ...
        } while (nextElem = nextElem.nextSibling)return sibs;
    },
        ...
        if (e.isVariableDefined(picker)) {
            ...
            element.forEach(function(item) {
                ...
                flatpickr(item, {
                    ...
                    //Check supported characters here: https://flatpickr.js.org/formatting/
                    disableMobile: "true"
                });
