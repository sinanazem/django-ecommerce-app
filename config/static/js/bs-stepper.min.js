...
!function(t, e) {
    ...
    !function() {
        if (window.Element.prototype.matches || (e = window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector),
        window.Element.prototype.closest || (n = function(t, n) {
        ...
        window.Event && "function" == typeof window.Event || (s = function(t, e) {
            ...
            return n.initEvent(t, Boolean(e.bubbles), Boolean(e.cancelable)),
            n
        }
        ),
    ...
    var r = {
      ...
      , a = function(t, e, n, s) {
        ...
        if (!o._steps[e].classList.contains(r.ACTIVE) && !o._stepsContents[e].classList.contains(r.ACTIVE)) {
            ...
            a.defaultPrevented || (p.length && p[0].classList.remove(r.ACTIVE),
            d.length && (d[0].classList.remove(r.ACTIVE),
            t.classList.contains(r.VERTICAL) || o.options.animation || d[0].classList.remove(r.BLOCK)),
      ...
      , l = function(t, e, n, s) {
        n.forEach(function(e) {
            ...
            t.classList.contains(r.LINEAR) && n.setAttribute("disabled", "disabled")
        }),
      ...
      , d = function(t, e) {
        ...
        window.setTimeout(function() {
            n || t.dispatchEvent(s(o)),
            t.removeEventListener(o, r)
        }, i)
    }
      , f = function(t, e) {
        e.animation && t.forEach(function(t) {
            t.classList.add(r.FADE),
            t.classList.add(r.NONE)
        })
    }
      , h = {
        linear: !0,
    ...
    return function() {
        ...
        return s._setLinkListeners = function() {
            ...
            this._steps.forEach(function(e) {
                ...
                t.options.linear ? (t._clickStepLinearListener = (t.options,
                function(t) {
                    t.preventDefault()
                }
                ),
                i.addEventListener("click", t._clickStepLinearListener)) : (t._clickStepNonLinearListener = (s = t.options,
                function(t) {
                    t.preventDefault();
